...
def main():
    ...
    # pose = conversions.to_pose_stamped("tray_center", [-0.307, 0.022, 0.083, -0.500, 0.500, 0.500, 0.500])
    # pose_0 = copy.deepcopy(pose)
    # pose_0.pose.position.z += 0.01
    # c.a_bot.move_lin(pose_0, speed=0.2)
    # c.confirm_to_proceed("go")
    # c.a_bot.move_lin(pose, speed=0.2)
